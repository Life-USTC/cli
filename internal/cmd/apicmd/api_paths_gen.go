...
var generatedAPIPaths = []string{
	...
	"/api/catalog/young-events/images/{path}",
	"/api/catalog/young-events/{youngId}",
	"/api/catalog/young-events/{youngId}/image",
	"/api/catalog/young-organizers",
	"/api/catalog/young-organizers/{organizerId}",
	"/api/community/comments",
	"/api/community/comments/batch",
	"/api/community/comments/{id}",
	"/api/community/comments/{id}/reactions",
	"/api/community/comments/{id}/replies",
	...
	"/api/health",
	"/api/ingestion/publications/batches",
	...
	"/api/workspace/young-notifications/{id}/read",
	"/api/workspace/young-organizer-subscriptions",
